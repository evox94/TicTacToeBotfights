...
public class TicTacToe extends JavaOnlyGame {
    ...
    protected String getTemplateFileName() {
        return "/rs/etf/stud/botfights/tictactoe/templates/TicTacToeBot.java";
    }
    ...
    public String getDescription() {
        ...
        final URL location = getClass().getResource("/rs/etf/stud/botfights/tictactoe/html/description.html");
        String content = null;
        try {
    ...
    * */
    ...
    private class ViewHolder implements GameView {
        ...
        private Color XColor = Color.rgb(139, 0, 0);
        private Color OColor = Color.rgb(0, 0, 139);
